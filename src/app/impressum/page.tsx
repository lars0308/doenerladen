    ...
    <>
      ...
      <section className="section legal-section">
        <div className="container legal-text">
          ...
          <h2>Umsatzsteuer</h2>
          <p>Steuernummer: 44 / 101 / 01314 (Finanzamt Stadthagen)</p>
          ...
          <h2>Angaben zur Speisekarte</h2>
          <p>
            Alle Preise verstehen sich in Euro inklusive der gesetzlichen Mehrwertsteuer. Preisänderungen und
            Irrtümer vorbehalten. Abbildungen können von den tatsächlichen Gerichten abweichen. Für Angaben zu
            Zusatzstoffen und Allergenen wird nach bestem Wissen gekennzeichnet — im Zweifel fragen Sie bitte unser
            Personal.
          </p>
        </div>
      </section>
